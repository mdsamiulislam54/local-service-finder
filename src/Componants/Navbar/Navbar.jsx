    ...
    <nav className="navbar bg-base-100 shadow-md sticky top-0 z-100">
      <div className="w-10/12 mx-auto flex">
        ...
        <dialog id="my_modal_1" className="modal">
          ...
          <div className= {`flex flex-col space-y-5  ${isForm ? "hidden":"block"}`}>
          <button onClick={handleEmailandPasswordBtn} className={`btn bg-white text-black border-[#e5e5e5]`}>
              <svg
            ...
            <form action="" className={`${isForm ? "block":"hidden"}`}>
